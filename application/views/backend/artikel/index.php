...
<section class="content">
    <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-info btn-sm" href="<?php echo base_url('admin/artikel/create');?>"><i class="fa fa-plus">Buat Artikel</i></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  foreach ($data as $key => $value) {
                    ...
                    $email=$value->tanggal;
                    $nama=$value->judul;
                    $telepon=$value->konten;
                    $urlEdit=base_url('admin/artikel/edit').'/'.$value->id;
                    $urlDelete=base_url('admin/artikel/delete').'/'.$value->id;
                ?>
                    <tr>
                      <td><?php echo $no;?></td>
