          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            ?>
                <tr>
                  ...
                  <td><a href="<?php echo $urlEdit ?>" class="btn btn-sm btn-warning <?php echo $hideKonfirmasi?>"><i class=""></i> Konfirmasi</a>&nbsp;<a href="<?php echo $urlDelete ?>" class="btn btn-sm btn-info <?php echo $hideLunas?>"><i class=""></i> Lunas</a></td>
                </tr>
            <?php  }?>
            </tbody>
          </table>
