        ...
        <div class="col-md-12">
          <div class="box-news">
            <div class="list-article-big">
                <h1> Register</h1>
                    <form action="<?php echo base_url('reservasi/register-checkout') ?>" method="post">
                        <div class="form-group">
                          <label>E-Mail</label>
                      ...
                      <input type="hidden" name="id_detail_lapang" value="<?php echo $id_detail_lapang ?>">
                      <input type="hidden" name="tanggal_reservasi" value="<?php echo $tanggal_reservasi ?>">
                      <input type="submit" name="submit" class="btn btn-info btn-sm" value="Lanjutkan">
                    </form>
            </div>
          </div>
        </div>
