          ...
          <div class="box-news">
            <div class="list-article-big">
              <div class="col-md-4 nopadding">
                <div class="img-thumb-big" style="background: url('assets/uploads/<?php echo $artikel[0]->gambar?>');"></div>
              </div>
              <div class="col-md-8 grey-bg-big">
                <div class="desc-box-big">
                  <a href="<?php echo base_url('artikel').'/'.$artikel[0]->id ?>"><h3><?php echo $artikel[0]->judul?></h3></a>
                  <p><i class="fa fa-calendar"> </i> <?php echo $artikel[0]->tanggal?></p>
                  <p><?php echo html_entity_decode(substr($artikel[0]->konten,0,150), ENT_QUOTES, "utf-8") ?></p>
                  <a href="<?php echo base_url('artikel').'/'.$artikel[0]->id ?>" class="btn btn-red pull-right">SELENGKAPNYA</a>
                </div>
              </div>
            </div>
          </div>
