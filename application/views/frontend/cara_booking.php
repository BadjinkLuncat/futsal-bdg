      ...
      <div class="container-fluid nopadding">
        ...
        <div class="collapse navbar-collapse nopadding" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<?php echo base_url('cara-booking') ?>">CARA BOOKING</a></li>
            ...
            <div class="list-article-big">
              <div class="span-18 last" style="padding-top:10px">
                ...
                <h1>Cara Booking</h1>
                  ...
                  <p style="text-align: justify;">Berikut ini langkah-langkah dalam melakukan pemesanan lapangan futsal</p>
                  <p style="text-align: justify;"></p>
                  <ol>
                    <li>Silahkan klik pada tempat futsal yang dinginkan</li>
                    ...
                    <li>Setelah selesai, klik checkout pada keranjang pemesanan anda (terdapat pada bagian bawah atau pada meunu keranjang booking)</li>
                    <li>Silahkan masukan data diri anda setelah itu klik "Finish"</li>
                    <li>Lakukan pembayaran melalui transfer bank, setelah itu lakukan konfirmasi melalui email dan sms ke 08532112367 <br></li>
                    <li>Operator kami akan segera memproses pesanan anda begitu mendapatkan konfirmasi pembayaran</li>
                    <li>Lapangan futsal sudah selesai dipesan</li>
                  </ol><p></p>
              </div>
            </div>
          </div>
