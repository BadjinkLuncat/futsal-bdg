...
<body>
  ...
  <section class="content2">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <?php if ($artikel) { foreach ($artikel as $key => $value) {?>
            <div class="box-news">
              <div class="list-article-big" style="width: 100%">
                <div class="col-md-4 nopadding">
                  <div class="img-thumb-big" style="background: url('assets/uploads/<?php echo $value->gambar?>');"></div>
                </div>
                <div class="col-md-8 grey-bg-big">
                  <div class="desc-box-big">
                    <a href="<?php echo base_url('artikel').'/'.$value->id ?>"><h3><?php echo $artikel[0]->judul?></h3></a>
                    <p><i class="fa fa-calendar"> </i> <?php echo $value->tanggal?></p>
                    <p><?php echo html_entity_decode(substr($value->konten,0,150), ENT_QUOTES, "utf-8") ?></p>
                    <a href="<?php echo base_url('artikel').'/'.$value->id ?>" class="btn btn-red pull-right">SELENGKAPNYA</a>
                  </div>
                </div>
              </div>
            </div>
