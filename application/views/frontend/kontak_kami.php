      ...
      <div class="container-fluid nopadding">
        ...
        <div class="collapse navbar-collapse nopadding" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<?php echo base_url('kontak-kami') ?>">KONTAK KAMI</a></li>
          ...
          <div class="box-news">
            <div class="list-article-big">
              <div class="span-18 last" style="padding-top:10px">
                <h1>Hubungi Kami</h1>
                BookingFutsal.com
                <div>Jl. Asia Afrika No. 90 Bandung</div>
                <div>Jawa Barat, Indonesia</div>
                <div><br></div>
                <ul class="aw-i-list" style="margin: 0px; padding: 0px; list-style: none; color: rgb(51, 51, 51); font-family: arial, helvetica, sans-serif; background-color: rgb(255, 255, 255); ">
                  <li class="aw-i-list-li aw-creative-line aw-creative-line-2" gwtdebugid="text-ad-preview-description2" dir="" style="margin: 0px; padding: 0px; list-style: none; display: block; white-space: nowrap; overflow: hidden; line-height: 1.2; ">Telp. 022 9123 0912 / 9140 6676</li>
                  <li class="aw-i-list-li aw-creative-line aw-creative-line-2" gwtdebugid="text-ad-preview-description2" dir="" style="margin: 0px; padding: 0px; list-style: none; display: block; white-space: nowrap; overflow: hidden; line-height: 1.2; ">Email. bookingfutsal@gmail.com</li>
                </ul>
              </div>
            </div>
          </div>
